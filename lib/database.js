...
var async, axon, compactViews, configureCouchClient, couchClient, couchUrl, couchdbHost, couchdbPort, exec, fs, getAuthCouchdb, helpers, log, makeError, path, program, qs, request, spawn, waitCompactComplete;
